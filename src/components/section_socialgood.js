    ...
    return (
        <div className="container-fluid p-0">
            <div className={`row no-gutters align-items-center ${styles.background}`}>
                <div className={`col-10 offset-1 col-md-4 offset-md-1 order-2 order-md-1 ${styles.description} ${props.fadeSocialGood && styles.slideinright}`}>
                ...
                <div className={`${styles.social_good_container} ${props.fadeSocialGood && styles.slideinleft} col-10 offset-1 col-md-5 offset-md-1 order-1 order-md-2`}>
