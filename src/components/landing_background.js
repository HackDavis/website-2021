    ...
    return (
        <div className={styles.background}>
            ...
            <div className={`${styles.left_side_container}`}>
                <img onLoad={OnImageLoad()} alt="" src={images["Layer 1"]} style={{}} className={styles.layer1_left}></img>
                <img onLoad={OnImageLoad()} alt="" src={images["Layer 2"]}></img>
                <img onLoad={OnImageLoad()} alt="" src={images["Heart Orb"]} style={{}} className={styles.heart_orb}></img>
                <img onLoad={OnImageLoad()} alt="" src={images["Heart"]} style={{}} className={styles.heart}></img>
                <img onLoad={OnImageLoad()} alt="" src={images["Heart Arrow"]} style={{}} className={styles.heart_arrow}></img>
